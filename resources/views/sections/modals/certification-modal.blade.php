<div class="modal fade" id="barangayCertificateModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">


            <div class="modal-body p-4">
                <h4 class="text-center text-success fw-bold mb-4">Barangay Certificate Request Form</h4>

                <form id="barangayCertificateForm" class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="date" class="form-control" id="bcertDob" required>
                    </div>
                    <div class="col-md-2">
                        <label class="form-label">Age</label>
                        <input type="text" class="form-control" id="bcertAge" readonly>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control" placeholder="Select Year of Residency" min="1900"
                            max="2099" step="1">
                    </div>
            ...
            <div class="modal-footer border-0 d-flex justify-content-end pt-0 pb-4 px-4">
                ...
                <button type="submit" form="barangayCertificateForm" class="btn btn-success ms-2">Submit</button>
            </div>
